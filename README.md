...
```text Building Jenkins Pipelines on Amazon Linux 2 AWS EC2 Instance
```
```text Configuring Jenkins Pipeline with GitHub Webhook to Build the a Java Maven Project
```
